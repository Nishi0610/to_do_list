...
<body class="flex flex-col min-h-[100vh]">
                ...
                <form action="/tasks/{{ $task->id }}" method="post" class="mt-10">
                    ...
                    <div class="flex flex-col items-center">
                        <label class="w-full max-w-3xl mx-auto">
                            <input
                                class="placeholder:italic placeholder:text-slate-400 black bg-white w-full border-slate-300 rounded-md py-4 pl-4 shadow-sm focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text:sm"
                        ...
                        <div class="mt-8 w-full flex item-center justify-center gap-10">
    ...
    <footer class="bg-slate-800">
        <div class="max-w-7xl mx-auto px-4 am:px-6">
